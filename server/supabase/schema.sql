...
CREATE UNIQUE INDEX IF NOT EXISTS idx_rubros_sag_nombre ON RUBROS (LOWER(nombre)) WHERE cuenta_id IS NULL;
CREATE UNIQUE INDEX IF NOT EXISTS idx_rubros_cuenta_nombre ON RUBROS (cuenta_id, LOWER(nombre)) WHERE cuenta_id IS NOT NULL;
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_sub_rubros_sag_nombre ON SUB_RUBROS (LOWER(nombre)) WHERE cuenta_id IS NULL;
CREATE UNIQUE INDEX IF NOT EXISTS idx_sub_rubros_cuenta_nombre ON SUB_RUBROS (cuenta_id, LOWER(nombre)) WHERE cuenta_id IS NOT NULL;
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_grupo_iconos_sag_grupo ON GRUPO_ICONOS (LOWER(grupo)) WHERE cuenta_id IS NULL;
CREATE UNIQUE INDEX IF NOT EXISTS idx_grupo_iconos_cuenta_grupo ON GRUPO_ICONOS (cuenta_id, LOWER(grupo)) WHERE cuenta_id IS NOT NULL;
