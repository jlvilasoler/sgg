          ...
          <div className="stock-ganadera-main stock-import-main">
            <div className="stock-cabana-form card stock-baja-manual-buscar">
              ...
              <form id={formId} className="stock-cabana-form-grid" onSubmit={agregarPendiente}>
                ...
                {seleccion ? (
                  <div className="stock-cabana-seleccion">
                ...
                <div className="stock-cabana-acciones">
                  <button
                    type="button"
                  ...
                  <button
                    type="button"
                    className="btn btn-primary stock-import-action--cabana"
                    disabled={!apiOnline || guardando || !seleccion}
            ...
            {pendientes.length > 0 ? (
              <div className="stock-import-panel card stock-cabana-pendientes">
                <header className="stock-cabana-section-head">
                  <div>
                    <p className="stock-cabana-kicker">Lista temporal</p>
                    <h3 className="stock-cabana-section-title">Pendientes de guardar</h3>
                  </div>
                  <span className="stock-cabana-count">{pendientes.length}</span>
                </header>
                  ...
                  {pendientes.map((row) => (
                    <li key={row.id} className="stock-cabana-row stock-cabana-row--pendiente">
                      <div className="stock-cabana-row-main">
                        ...
                        {row.raza ? (
                          <span className="stock-cabana-row-meta">{fmtRaza(row.raza)}</span>
                        ) : null}
                      </div>
                      <button
                        type="button"
            ...
            <div className="stock-import-panel card stock-cabana-lista">
              <header className="stock-cabana-section-head">
                <div>
                ...
                <span className="stock-cabana-count">{guardados.length}</span>
              </header>
                  ...
                  {guardados.map((d) => (
                    <li key={d.clave} className="stock-cabana-row stock-cabana-row--guardado">
                      <div className="stock-cabana-row-main">
                        ...
                        {[d.sexo, d.empresa, d.raza].filter(Boolean).length > 0 ? (
                          <span className="stock-cabana-row-meta">
                            {[d.sexo, d.empresa, d.raza ? fmtRaza(d.raza) : ""]
                              .filter(Boolean)
                              .join(" · ")}
                          </span>
                        ) : null}
                      ...
                      <div className="stock-cabana-row-actions">
                        ...
                        <button
                          type="button"
                          className="btn btn-ghost btn-sm stock-cabana-btn-quitar"
                          disabled={guardando}
