...
import { filtrarModulosHub, mostrarDashboardEnBusquedaModulos } from "./stock-ganadero-hub-search";
...
export function StockGanaderoHubAsideSearchField({
  value,
  onChange,
  inputRef,
}: SearchFieldProps) {
...
export function useStockGanaderoAsideSearch(items: StockGanaderoHubItem[]) {
