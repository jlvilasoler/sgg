...
export interface StockOvinoHubItem {
  id: string;
  label: string;
  subtitle: string;
  icon: HubIconId;
...
export default function StockOvinoHub({
  apiOnline,
  resumen,
  items,
  onNavigate,
  ...
  const primaryIds = new Set(["ovina", "importar", "sanidad", "salidas"]);
  ...
  return (
    <div className="sg-hub">
      <aside className="sg-hub-aside" aria-label="Navegación Stock Ovino">
      ...
      <main className="sg-hub-main sg-hub-main--module">
        <header className="sg-hub-main-head">
          <div>
            ...
            <p className="sg-hub-main-sub">
              Identificación electrónica (REG), stock ovino activo, salidas y sanidad en un solo lugar.
            </p>
          </div>
          <div className="sg-hub-main-actions">
            ...
            <button type="button" className="sg-hub-cta" onClick={() => onNavigate("ovina")}>
              Ver dispositivos
            </button>
          </div>
        </header>
        ...
        <section className="sg-hub-kpi-strip" aria-label="Indicadores">
          <SgHubKpi
            ...
            hint="Caravanas electrónicas ovinas únicas registradas en la base."
        ...
        <div className="sg-hub-panels">
          <section className="sg-hub-panel sg-hub-panel--modules" aria-labelledby="sg-ovino-hub-mod-title">
            <div className="sg-hub-panel-head">
              <div>
                <p className="sg-hub-panel-kicker">Accesos rápidos</p>
                <h2 id="sg-ovino-hub-mod-title" className="sg-hub-panel-title">
                  Módulos principales
                </h2>
              </div>
            </div>
          ...
          <section className="sg-hub-panel sg-hub-panel--flow" aria-labelledby="sg-ovino-hub-flow-title">
            <div className="sg-hub-panel-head">
              <div>
                <p className="sg-hub-panel-kicker">Flujo recomendado</p>
                <h2 id="sg-ovino-hub-flow-title" className="sg-hub-panel-title">
                  Cómo usar el módulo
                </h2>
              </div>
            </div>
            <ol className="sg-hub-flow-list">
              ...
              <li>
                ...
                <div>
                  <strong>Stock Ovino</strong>
                  <p>Revisá, filtrá y editá cada caravana ovina.</p>
                </div>
              </li>
              <li>
        ...
        <section className="sg-hub-panel sg-hub-panel--secondary" aria-labelledby="sg-ovino-hub-sec-title">
          <div className="sg-hub-panel-head">
            <div>
              <p className="sg-hub-panel-kicker">Más herramientas</p>
              <h2 id="sg-ovino-hub-sec-title" className="sg-hub-panel-title">
