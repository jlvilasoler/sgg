...
import StockEditarFichaEdadDisplay from "../stock/StockEditarFichaEdadDisplay";
...
export default function StockOvinaEvolucionTimeline({
  nacimientoMes,
  nacimientoAnio,
  edadMeses,
  sexo,
      ...
      <div className="stock-edit-evolucion-card">
        ...
        <div className="stock-evolucion-head">
          ...
          <span className="stock-evolucion-rango">
            {esMacho
              ? "Cordero · Borrego · Capón / Carnero"
              : esHembra
                ? "Cordera · Borrega · Oveja"
