...
import { filtrarModulosHub, mostrarDashboardEnBusquedaModulos } from "./stock-ovino-hub-search";
...
export function StockOvinoHubAsideSearchField({
  value,
  onChange,
  inputRef,
}: SearchFieldProps) {
...
export function useStockOvinoAsideSearch(items: StockOvinoHubItem[]) {
