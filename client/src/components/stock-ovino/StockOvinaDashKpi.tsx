...
import type { SexoDispositivoCounts } from "./stock-ovina-utils";

export type StockOvinaDashKpiVariant =
  | "total"
  | "activos"
  | "salida"
  | "vendido"
...
interface Props {
  ...
  value: number | string;
  hint: string;
  variant: StockOvinaDashKpiVariant;
...
function KpiIcon({ variant }: { variant: StockOvinaDashKpiVariant }) {
  switch (variant) {
    case "total":
      return (
...
export default function StockOvinaDashKpi({
  label,
  value,
  hint,
  variant,
